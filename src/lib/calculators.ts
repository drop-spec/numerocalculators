...
export const calculators: Calculator[] = [
  ...
  c("profit-margin-calculator", "Profit Margin Calculator", "money", [n("revenue","Revenue",1000,"$"),n("cost","Cost",650,"$")], "margin", "Calculate profit and profit margin from revenue and costs."),
